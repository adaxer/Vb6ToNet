...
Dim i As Integer
    ...
    'datenbanksprachänderungen
        ...
        'Typ Datasource: "SELECT * FROM art_de_en WHERE (hersteller = 'damussnureinANDrein' or (hersteller like '%siegling%' and (typenreihe = 'transilon' or typenreihe = 'transvent'))  or (hersteller like '%siegling%' and (typenreihe = 'extremultus'))  ) ORDER BY artnr"
            Sys(1).S(1) = "Typ('typ')"
